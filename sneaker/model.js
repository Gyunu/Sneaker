...
class Model {
  ...
  static where(column = null, predicate = null, value = undefined, database = undefined) {
    ...
    let instance = (database) ? new this({database: database}) : new this();
  ...
  static whereBetween(column = null, start = undefined, end = undefined, database = undefined) {
    if(!column) { throw new Error('Model.where: column not defined')}
  ...
  static find(id = null, database = undefined) {
